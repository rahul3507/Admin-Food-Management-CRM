...
export function RiderDetailsModal({
  ...
  const detailRows = [
    { label: "Sl No.", value: rider.id },
    { label: "Rider name :", value: rider.riderName },
    { label: "Email :", value: rider.email },
    { label: "Mobile Number :", value: maskPhoneNumber(rider.number) },
    { label: "License Plate Number :", value: rider.licensePlateNumber },
    { label: "Registration Number :", value: rider.registrationNumber },
    {
      label: "Date :",
      value: new Date()
